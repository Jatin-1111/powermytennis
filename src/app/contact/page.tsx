          ...
          <div className="order-2 lg:order-1 flex flex-col h-full gap-8">
            <div className="bg-brand-neutral/10 p-8 rounded-3xl border border-brand-neutral/20 shadow-sm flex flex-col sm:flex-row gap-6 items-center sm:items-start justify-between">
              <div className="text-center sm:text-left">
                <h3 className="font-black text-brand-primary uppercase tracking-widest text-lg mb-2">
                  Call Us
                </h3>
                <p className="text-brand-black text-lg font-medium tracking-wide">
                  {siteConfig.phone}
                </p>
              </div>
              <div className="flex gap-4">
                <a
                  ...
                  aria-label="Call Us"
                  className="w-14 h-14 rounded-full bg-brand-primary text-brand-white flex items-center justify-center hover:bg-brand-secondary transition-colors shadow-md"
                >
                  <svg
                    className="w-6 h-6"
                    fill="none"
                ...
                <a
                  ...
                  className="w-14 h-14 rounded-full bg-brand-accent text-brand-primary flex items-center justify-center hover:bg-[#b0c426] transition-colors shadow-md"
                >
                  <svg
                    className="w-7 h-7"
                    fill="currentColor"
            ...
            <Suspense
              fallback={
                <div className="bg-brand-neutral/10 p-12 rounded-3xl animate-pulse h-[600px] flex flex-col items-center justify-center border border-brand-neutral/20">
                  ...
                  <p className="text-brand-primary font-black tracking-widest uppercase text-xl">
                    Loading Form...
                  </p>
                </div>
              }
