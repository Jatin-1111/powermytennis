...
export const metadata = {
  title: 'Coaching Team | PowerMyTennis High Performance Academy',
  description: 'Meet our formidable coaching team with 80+ years of cumulative coaching experience.',
};
      ...
      <div className="bg-brand-primary py-24 md:py-32 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 px-4">
          <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tight text-brand-white mb-6">
            A Formidable<br className="md:hidden" /> Coaching Team
          </h1>
