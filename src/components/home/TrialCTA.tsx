          ...
          <MotionSection stagger>
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  <li key={benefit} className="flex items-start gap-3">
                    ...
                    <span className="text-brand-white/75 font-medium text-sm">
                      {benefit}
                    </span>
                  </li>
                ))}
            ...
            <MotionItem>
              <div className="flex items-center gap-4 pt-6 border-t border-brand-white/10">
                ...
                <span className="text-brand-white/20 text-xs">
              ...
              {state.success ? (
                ...
                >
                  <input
                    type="hidden"
                    name="message"
                    value="Free trial session inquiry from homepage."
                  />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label
                        htmlFor="trial-name"
                        className="block text-[10px] font-black uppercase tracking-[0.2em] text-brand-white/40 mb-2"
                      >
                        Player / Parent Name
                      </label>
                      <input
