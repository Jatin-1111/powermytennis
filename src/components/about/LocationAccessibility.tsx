    ...
    <section className="py-24 bg-brand-neutral/20 border-t border-brand-neutral/30">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-black text-brand-primary uppercase tracking-tight mb-6">
              Accessible to the TriCity
            </h2>
            <p className="text-xl text-brand-black mb-10 leading-relaxed font-medium">
            ...
            <div className="bg-brand-white p-8 rounded-2xl border border-brand-neutral/40 shadow-md mb-8">
              <h3 className="font-black uppercase text-xl text-brand-secondary mb-3 flex items-center tracking-wide">
              ...
              <p className="text-brand-black text-lg">{siteConfig.address.city}</p>
            </div>
          </div>
          
          <div className="h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl bg-brand-neutral/50 relative border-4 border-brand-white">
            <iframe 
