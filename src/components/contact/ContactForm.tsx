...
export function ContactForm() {
  ...
  if (state.success) {
    return (
      <div className="bg-brand-neutral/10 border-2 border-brand-accent rounded-3xl p-10 text-center shadow-lg h-full flex flex-col items-center justify-center min-h-[400px]">
        ...
        <h3 className="text-3xl font-black text-brand-primary uppercase tracking-tight mb-4">Message Sent!</h3>
  ...
  return (
    <form action={formAction} className="bg-brand-white p-8 md:p-12 rounded-3xl shadow-2xl border border-brand-neutral/30 h-full">
      ...
      <div className="space-y-6">
        <div>
          <label htmlFor="name" className="block text-sm font-bold text-brand-secondary mb-2 uppercase tracking-widest">Full Name</label>
          <input 
            type="text" 
            id="name" 
            name="name" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="phone" className="block text-sm font-bold text-brand-secondary mb-2 uppercase tracking-widest">Phone Number</label>
            <input 
              type="tel" 
              id="phone" 
              name="phone" 
          ...
          <div>
            <label htmlFor="email" className="block text-sm font-bold text-brand-secondary mb-2 uppercase tracking-widest">Email Address</label>
            <input 
              type="email" 
              id="email" 
              name="email" 
        ...
        <div>
          <label htmlFor="program" className="block text-sm font-bold text-brand-secondary mb-2 uppercase tracking-widest">Program of Interest</label>
          <select 
            id="program" 
            name="program" 
            required 
        ...
        <div>
          <label htmlFor="message" className="block text-sm font-bold text-brand-secondary mb-2 uppercase tracking-widest">Your Message</label>
          <textarea 
            id="message" 
            name="message" 
            required 
